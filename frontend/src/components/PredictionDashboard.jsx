...
const PredictionDashboard = ({ predictions }) => {
  ...
  // Mobile-specific ordering: Disease Overview → Disease Info → Current Conditions → Air Quality
  const mobileOrder = (
    <>
      {/* Disease Overview - Always first on mobile */}
      <div className="bg-black/80 rounded-2xl p-6 shadow-2xl border border-gray-800/50 h-fit backdrop-blur-sm mb-4">
      ...
      {/* Disease Info - Second on mobile, hidden on desktop left panel */}
      <div className="bg-black/80 rounded-2xl p-6 shadow-2xl border border-gray-800/50 h-80 flex flex-col justify-center items-center text-center backdrop-blur-sm space-y-4 mb-4 xl:block xl:h-auto">
      ...
      {/* Current Conditions - Third on mobile, hidden on desktop left panel */}
      <div className="bg-black/80 rounded-2xl p-6 shadow-2xl border border-gray-800/50 h-80 backdrop-blur-sm space-y-4 mb-4 hidden xl:block xl:h-auto">
      ...
      {/* Air Quality Index - Fourth on mobile */}
      <div className="bg-black/80 rounded-2xl p-6 shadow-2xl border border-gray-800/50 h-fit backdrop-blur-sm mb-4">
        <h2 className="text-xl font-bold text-gray-200 mb-6 border-b border-gray-700/50 pb-3 flex items-center">
          <span className="mr-2">🌫️</span>
          Air Quality Index
  ...
  return (
    <div className="py-8 px-4 max-w-7xl mx-auto">
      ...
      {/* Desktop Layout: Left Tall Panel | Right 3-Row Stack */}
      <div className="hidden xl:grid xl:grid-cols-4 xl:gap-8">
        ...
        <div className="xl:col-span-1 space-y-4">
          ...
          <div className="bg-black/80 rounded-2xl p-7 shadow-2xl border border-gray-800/50 h-fit backdrop-blur-sm">
            <h2 className="text-xl font-bold text-gray-200 mb-6 border-b border-gray-700/50 pb-3 flex items-center">
              <span className="mr-2">🌫️</span>
              Air Quality Index
            </h2>
        ...
        <div className="xl:col-span-3 space-y-3">
          ...
          <div className="bg-black/80 rounded-2xl p-6 shadow-2xl border border-gray-800/50 backdrop-blur-sm">
            <h2 className="text-xl font-bold text-gray-200 mb-7 border-b border-gray-700/50 pb-3 flex items-center">
              <span className="mr-2">📍</span>
              Location & Demographics
            </h2>
